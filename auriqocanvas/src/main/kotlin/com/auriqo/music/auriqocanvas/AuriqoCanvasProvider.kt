package com.auriqo.music.appupdatecanvas
...
@Serializable
data class AuriqoCanvasManifest(
    val items: List<AuriqoCanvasItem> = emptyList()
)

@Serializable
data class AuriqoCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object AuriqoCanvasProvider {
    private const val BASE_URL = "https://canvas.auriqo.app/canvas.json"
    ...
    private data class CacheEntry(
        val value: AuriqoCanvasManifest?,
    ...
    private suspend fun fetchManifest(): AuriqoCanvasManifest? {
        ...
        return try {
            val manifest: AuriqoCanvasManifest = client.get(BASE_URL).body()
