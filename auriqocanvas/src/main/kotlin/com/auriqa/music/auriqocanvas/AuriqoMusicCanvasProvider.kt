package com.auriqa.music.auriqocanvas
...
@Serializable
data class auriqaCanvasManifest(
    val items: List<auriqaCanvasItem> = emptyList()
)

@Serializable
data class auriqaCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object auriqaCanvasProvider {
    ...
    private data class CacheEntry(
        val value: auriqaCanvasManifest?,
    ...
    private suspend fun fetchManifest(): auriqaCanvasManifest? {
        ...
        return try {
            val manifest: auriqaCanvasManifest = client.get(BASE_URL).body()
