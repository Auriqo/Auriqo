...
import com.auriqo.music.constants.AutomixDebugOverlayKey
...
import com.auriqo.music.constants.EnableGoogleCastKey
...
highlightKey: String? = null) {
    ...
    val (dataSaverEnabled, onDataSaverEnabledChange) = rememberPreference(
        key = com.auriqo.music.constants.DataSaverEnabledKey,
        defaultValue = false
    )
    ...
    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        com.auriqo.music.constants.DownloadQualityKey,
        defaultValue = com.auriqo.music.constants.DownloadQuality.YOUTUBE
    )
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            onSelect = {
                if (it == com.auriqo.music.constants.DownloadQuality.LOSSLESS) {
            ...
            values = listOf(com.auriqo.music.constants.DownloadQuality.YOUTUBE, com.auriqo.music.constants.DownloadQuality.LOSSLESS),
            valueText = {
                when (it) {
                    com.auriqo.music.constants.DownloadQuality.YOUTUBE -> "YouTube Music (AAC/Default)"
                    com.auriqo.music.constants.DownloadQuality.LOSSLESS -> "Lossless"
                }
            }
        )
    }
            ...
            DefaultDialog(
                ...
                buttons = {
                    ...
                    TextButton(onClick = {
                        ...
                        onDownloadQualityChange(com.auriqo.music.constants.DownloadQuality.LOSSLESS)
                    }) {
                        Text(stringResource(R.string.enable))
                    }
                }
    ...
    isHighlighted = (highlightKey == stringResource(R.string.echo_equalizer)),
                    icon = painterResource(R.drawable.auriqoequlizer),
