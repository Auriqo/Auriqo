package com.auriqo.music.ui.screens.equalizer.axion
...
class AxionEqViewModel @Inject constructor(
    ...
    private val prefs = context.getSharedPreferences("auriqo_eq_prefs", Context.MODE_PRIVATE)
    ...
    val customProfiles = eqProfileRepository.profiles.map { profiles ->
        profiles.filter { it.isCustom && it.id != "auriqo_tuning" }
