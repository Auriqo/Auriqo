...
object IconUtils {
    fun setIcon(context: Context, isDynamic: Boolean, isLegacy: Boolean) {
        ...
        val dynamic = ComponentName(context, "com.auriqo.music.MainActivityAlias")
        val static = ComponentName(context, "com.auriqo.music.MainActivityStatic")
        val legacy = ComponentName(context, "com.auriqo.music.MainActivityLegacy")
