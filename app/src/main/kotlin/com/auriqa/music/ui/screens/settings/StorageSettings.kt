...
import com.auriqo.music.constants.MaxImageCacheSizeKey
...
import com.auriqo.music.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    com.auriqo.music.playback.ExoDownloadService::class.java,
                    false
                )
