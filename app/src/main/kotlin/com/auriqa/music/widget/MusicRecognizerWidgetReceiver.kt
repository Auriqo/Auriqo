...
import com.auriqo.music.recognition.MusicRecognitionService
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import com.auriqo.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "com.auriqo.music.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.auriqo.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.auriqo.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.auriqo.music.widget.recognizer.RESET"
    }
}
